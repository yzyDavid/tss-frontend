...
export default class scoreUploadComponent extends Component<ScoreProps, {}> {
    ...
    changeClass(e) {
        this.props.dispatch({
            type: "scoreUpload/change_class",
            payload: {"uid": this.uid, "classname": e.target.value}
        });
        this.forceUpdate();
    }
            ...
            <div>
                <table>
                    ...
                    <tr>
                        ...
                        <td><select className="scoreSelect" style={{width: "100px"}}
                                    onBlur={this.changeClass.bind(this)}>
                ...
                <table className="scoreTable"
                       style={{align: "center", cellPadding: "15px", margin: "0px auto", width: "80%"}}>
                    ...
                    <tr>
                        ...
                        <td>
                            <div contentEditable={true}
                                 onBlur={this.changeScore.bind(this, 0)}>{_state.scores[_state.page * 12 + 0]}</div>
                        </td>
                    </tr>
                    ...
                    <tr className="oddLine">
                        ...
                        <td>
                            <div contentEditable={true}
                                 onBlur={this.changeScore.bind(this, 1)}>{_state.scores[_state.page * 12 + 1]}</div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <div contentEditable={true}
                                 onBlur={this.changeScore.bind(this, 2)}>{_state.scores[_state.page * 12 + 2]}</div>
                        </td>
                    </tr>
                    ...
                    <tr className="oddLine">
                        ...
                        <td>
                            <div contentEditable={true}
                                 onBlur={this.changeScore.bind(this, 3)}>{_state.scores[_state.page * 12 + 3]}</div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <div contentEditable={true}
                                 onBlur={this.changeScore.bind(this, 4)}>{_state.scores[_state.page * 12 + 4]}</div>
                        </td>
                    </tr>
                    ...
                    <tr className="oddLine">
                        ...
                        <td>
                            <div contentEditable={true}
                                 onBlur={this.changeScore.bind(this, 5)}>{_state.scores[_state.page * 12 + 5]}</div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <div contentEditable={true}
                                 onBlur={this.changeScore.bind(this, 6)}>{_state.scores[_state.page * 12 + 6]}</div>
                        </td>
                    </tr>
                    ...
                    <tr className="oddLine">
                        ...
                        <td>
                            <div contentEditable={true}
                                 onBlur={this.changeScore.bind(this, 7)}>{_state.scores[_state.page * 12 + 7]}</div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <div contentEditable={true}
                                 onBlur={this.changeScore.bind(this, 8)}>{_state.scores[_state.page * 12 + 8]}</div>
                        </td>
                    </tr>
                    ...
                    <tr className="oddLine">
                        ...
                        <td>
                            <div contentEditable={true}
                                 onBlur={this.changeScore.bind(this, 9)}>{_state.scores[_state.page * 12 + 9]}</div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <div contentEditable={true}
                                 onBlur={this.changeScore.bind(this, 10)}>{_state.scores[_state.page * 12 + 10]}</div>
                        </td>
                    </tr>
                    ...
                    <tr className="oddLine">
                        ...
                        <td>
                            <div contentEditable={true}
                                 onBlur={this.changeScore.bind(this, 11)}>{_state.scores[_state.page * 12 + 11]}</div>
                        </td>
                    </tr>
                ...
                <table style={{margin: "0px auto", cellPadding: "20px", width: "60%"}}>
                    ...
                    <tr>
                        <td>
                            <button className="scoreButton" onClick={this.changePage.bind(this, -1)}>上一页</button>
                        </td>
                        <td>
                            <button className="scoreButton" onClick={this.changePage.bind(this, 1)}>下一页</button>
                        </td>
                        <td>
                            <button className="scoreButton" onClick={this.upload.bind(this)}>确认提交</button>
                        </td>
                    </tr>
                    </tbody>
                </table>
