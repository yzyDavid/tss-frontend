        ...
        return(
            <BrowserFrame>
                ...
                <div style={{marginLeft:300, marginRight:300}}>
                    <Pagination style={{marginTop:15}} showQuickJumper defaultCurrent={this.props.postList.currentPage} total={this.props.postList.totalPage} />
                    {
                    ...
                    <Pagination style={{marginTop:10}} showQuickJumper defaultCurrent={this.props.postList.currentPage} total={this.props.postList.totalPage} />
                </div>
            </BrowserFrame>
        )
    }
