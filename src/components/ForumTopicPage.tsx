...
export default class TopicPageComponent extends Component<TopicProps> {
    ...
    render() {
        ...
        for (var i = 0; i < this.props.allstate.id.length; i++) {
            ...
            if (quote === "") {
                ...
                q = <div style={{
                    ...
                    <div style={{
                        ...
                        marginLeft: 10,
                        fontSize: 10
                    }}>以下是引用{quoteIndex}楼用户&nbsp;{quoteAuthor}&nbsp;在{quoteTime}发表的内容
                    </div>
                    <div style={{marginTop: 10, marginLeft: 10, fontSize: 18}}
            ...
            replylist.push(
                <div style={{
                    marginLeft: 200, marginRight: 200, marginBottom: 20,
                    ...
                    <div style={{width: "96%", marginLeft: "auto", marginRight: "auto", marginTop: 10}}>
                        ...
                        <div>
                            ...
                            {q}
                            <div style={{marginTop: 45, marginBottom: 20, fontSize: 18}}
                                 dangerouslySetInnerHTML={{__html: text}}/>
                        </div>
                        <div onClick={this.replyFloor.bind(this, replyKey)} style={{textDecoration: "underline"}}>回复
                        </div>
        ...
        if (this.state.showQuote == true) {
            quoteZone = <div style={{
                ...
                <div style={{
                    ...
                    marginLeft: 10,
                    fontSize: 10
                }}>您将引用{quoteIndex}楼用户&nbsp;{quoteAuthor}&nbsp;在{quoteTime}发表的内容
                </div>
                <div style={{marginTop: 10, marginLeft: 10, fontSize: 18}}
        ...
        return (
            <BrowserFrame>
                ...
                <div style={{marginLeft: 200, marginTop: 10, fontSize: 20}}><a
                    href={"//localhost:3000/#/board=" + this.props.allstate.boardID}>{this.props.allstate.boardName}</a>
                </div>
                <Pagination style={{marginTop: 20, marginLeft: 200, marginBottom: 20}} showQuickJumper
                            defaultCurrent={this.props.allstate.currentPage} total={this.props.allstate.totalPage * 10}
                ...
                <Pagination style={{marginLeft: 200, marginBottom: 20,}} showQuickJumper
                            defaultCurrent={this.props.allstate.currentPage} total={this.props.allstate.totalPage * 10}
                            onChange={this.onPageChange}/>
                <div style={{marginLeft: 200, marginTop: 10, fontSize: 20, marginBottom: 20}}><a
                    href={"//localhost:3000/#/board=" + this.props.allstate.boardID}>{this.props.allstate.boardName}</a>
                </div>
                ...
                <div style={{marginLeft: window.innerWidth / 2 - 10}}><Button type="primary"
                                                                              onClick={this.postReply}>回复</Button></div>
            </BrowserFrame>
        )
    }
}