...
/*    cid: string;
    ...
    upload() {
        ...
        tssfetch("/grade/add", "PUT", {
            "uid": this,
            uid,
            "cid": _this.cid,
            "studentid": _this.state.students,
    ...
    render() {
        return (
            <div>
                ...
                <table ref={(scoreTable) => this.scoreTable = scoreTable} id="scoreTable" align="center"
                       line-height="20px" cellPadding="15px" margin="0px auto" width="80%">
                    ...
                    <tr>
                        ...
                        <td>
                            <div contentEditable="true"
                                 onBlur={this.changeScore.bind(this, 0)}>{this.state.score[this.page * 12 + 0]}</div>
                        </td>
                    </tr>
                    ...
                    <tr className="oddLine">
                        ...
                        <td>
                            <div contentEditable="true"
                                 onBlur={this.changeScore.bind(this, 1)}>{this.state.score[this.page * 12 + 1]}</div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <div contentEditable="true"
                                 onBlur={this.changeScore.bind(this, 2)}>{this.state.score[this.page * 12 + 2]}</div>
                        </td>
                    </tr>
                    ...
                    <tr className="oddLine">
                        ...
                        <td>
                            <div contentEditable="true"
                                 onBlur={this.changeScore.bind(this, 3)}>{this.state.score[this.page * 12 + 3]}</div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <div contentEditable="true"
                                 onBlur={this.changeScore.bind(this, 4)}>{this.state.score[this.page * 12 + 4]}</div>
                        </td>
                    </tr>
                    ...
                    <tr className="oddLine">
                        ...
                        <td>
                            <div contentEditable="true"
                                 onBlur={this.changeScore.bind(this, 5)}>{this.state.score[this.page * 12 + 5]}</div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <div contentEditable="true"
                                 onBlur={this.changeScore.bind(this, 6)}>{this.state.score[this.page * 12 + 6]}</div>
                        </td>
                    </tr>
                    ...
                    <tr className="oddLine">
                        ...
                        <td>
                            <div contentEditable="true"
                                 onBlur={this.changeScore.bind(this, 7)}>{this.state.score[this.page * 12 + 7]}</div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <div contentEditable="true"
                                 onBlur={this.changeScore.bind(this, 8)}>{this.state.score[this.page * 12 + 8]}</div>
                        </td>
                    </tr>
                    ...
                    <tr className="oddLine">
                        ...
                        <td>
                            <div contentEditable="true"
                                 onBlur={this.changeScore.bind(this, 9)}>{this.state.score[this.page * 12 + 9]}</div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <div contentEditable="true"
                                 onBlur={this.changeScore.bind(this, 10)}>{this.state.score[this.page * 12 + 10]}</div>
                        </td>
                    </tr>
                    ...
                    <tr className="oddLine">
                        ...
                        <td>
                            <div contentEditable="true"
                                 onBlur={this.changeScore.bind(this, 11)}>{this.state.score[this.page * 12 + 11]}</div>
                        </td>
                    </tr>
                ...
                <table align="center" cellPadding="20px" width="30%">
                    ...
                    <tr>
                        <td>
                            <button className='btn' onClick={this.changePage.bind(this, -1)}>上一页</button>
                        </td>
                        <td>
                            <button className='btn' onClick={this.changePage.bind(this, 1)}>下一页</button>
                        </td>
                        <td>
                            <button className='btn' onClick={this.upload.bind(this)}>确认提交</button>
                        </td>
                    </tr>
                    </tbody>
                </table>
